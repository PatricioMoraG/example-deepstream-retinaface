...
// Forward declarations opcionales (si no incluyes la cabecera de DeepStream completa):
 ...
 *
 * @return std::vector<float> con todas las anchors concatenadas en formato
 *         [cx, cy, w, h,  cx, cy, w, h, ...].
 */
 ...
 * @param objectList        Vector de detecciones (bounding boxes).
